...
docker run  --add-host zipkin:$ZIPKINIP --publish 8082:8082 --publish 9082:9082 --rm  --volume $CONF:/$CONTAINER_DIR/conf --volume $LOGS:/$CONTAINER_DIR/logs --name logger logger
